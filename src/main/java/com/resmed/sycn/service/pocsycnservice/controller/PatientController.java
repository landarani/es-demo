...
public class PatientController {
    ...
    public Iterable<Patient> getByQuery(@RequestParam(name = "ecn") String ecn, @RequestParam(name = "condition")
            String condition, @RequestParam(name = "alertName") String alertName) {
